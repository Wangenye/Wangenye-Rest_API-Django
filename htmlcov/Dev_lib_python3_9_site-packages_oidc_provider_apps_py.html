...
<head>
    ...
    <title>Coverage for Dev/lib/python3.9/site-packages/oidc_provider/apps.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>Dev/lib/python3.9/site-packages/oidc_provider/apps.py</b> :
...
<div id="source">
    ...
    <p id="t4" class="run"><span class="n"><a href="#t4">4</a></span><span class="t"><span class="key">class</span> <span class="nam">OIDCProviderConfig</span><span class="op">(</span><span class="nam">AppConfig</span><span class="op">)</span><span class="op">:</span>&nbsp;</span><span class="r"></span></p>
    <p id="t5" class="pln"><span class="n"><a href="#t5">5</a></span><span class="t">&nbsp;</span><span class="r"></span></p>
    <p id="t6" class="run"><span class="n"><a href="#t6">6</a></span><span class="t">    <span class="nam">name</span> <span class="op">=</span> <span class="str">'oidc_provider'</span>&nbsp;</span><span class="r"></span></p>
    <p id="t7" class="run"><span class="n"><a href="#t7">7</a></span><span class="t">    <span class="nam">verbose_name</span> <span class="op">=</span> <span class="str">u'OpenID Connect Provider'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
